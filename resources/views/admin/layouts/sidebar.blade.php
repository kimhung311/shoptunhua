                ...
                <ul class="list-unstyled navbar__list">
                    ...
                    <li>
                        <a class="js-arrow" href="{{ route('admin.category.index') }}" >
                            <i class="fas fa-chart-bar"></i>Danh Mục Sản Phẩm </a><i class="fas fa-arrow-to-bottom"></i>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                    ...
                    <li>
                        <a class="js-arrow" href="{{ route('admin.product.index') }}" >
                            <i class="fas fa-chart-bar"></i> Sản Phẩm </a><i class="fas fa-arrow-to-bottom"></i>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                    ...
                    <li>
                        <a class="js-arrow" href="{{ route('admin.order.index') }}" >
                            <i class="fas fa-chart-bar"></i>  Đơn Hàng </a><i class="fas fa-arrow-to-bottom"></i>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                   <li>
                    ...
                    <li>
                        <a class="js-arrow" href="{{ route('admin.user.index') }}" >
                            <i class="fas fa-chart-bar"></i> Tài Khoản Admin </a><i class="fas fa-arrow-to-bottom"></i>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                    ...
                    <li>
                        <a class="js-arrow" href="{{ route('admin.customer.index') }}" >
                            <i class="fas fa-chart-bar"></i> Tài Khoản Người Dùng </a><i class="fas fa-arrow-to-bottom"></i>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
